...
internal sealed class FactionTerritoryTileConfiguration : IEntityTypeConfiguration<FactionTerritoryTile>
{
    public void Configure(EntityTypeBuilder<FactionTerritoryTile> builder)
    {
        builder.ToTable("faction_territory_tiles", table =>
        {
            table.HasCheckConstraint("ck_faction_territory_tiles_x", "x >= 0");
            table.HasCheckConstraint("ck_faction_territory_tiles_y", "y >= 0");
            table.HasCheckConstraint(
                "ck_faction_territory_tiles_active",
        ...
        builder.Property(tile => tile.FactionId).HasColumnName("faction_id");
        ...
        builder.HasIndex(tile => tile.FactionId).HasDatabaseName("ix_faction_territory_faction");
    }
}
